...
We will provide a template of your lab assignment report [here](https://box.nju.edu.cn/d/123a70ac8ff34595b18f/). You need to submit the report in your own repository. The format of your report can be Microsoft Doc or PDF. An example is `123456789拾佰仟_lab_2.pdf`.
